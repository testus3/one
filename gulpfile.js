...
const initBrowserSync = function (done) {
	...
	//const startPath = "/index.html"; index.html is now home.html
    browsersync.init({
        startPath: startPath,
        server: {
            ...
            middleware: [
                function (req, res, next) {
                    req.method = "GET";
                    if (req.url === '/attendance') {
                        req.url = '/attendance.html';
                    }
                    if (req.url === '/daily-tasks') {
                        req.url = '/daily-tasks.html';
                    }
					if (req.url === '/') {
                        req.url = '/index.html';
                    }
...
function watchFiles() {
    ...
    watch([
        ...
        paths.baseSrcAssets + "scss/icons/*.scss"], series(icons, reloadBrowserSync));
    watch([
